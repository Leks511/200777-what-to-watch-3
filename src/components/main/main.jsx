        ...
        <div className="movie-card__wrap">
          <div className="movie-card__info">
            ...
            <div className="movie-card__desc">
              <h2 className="movie-card__title">{filmDetails.title}</h2>
              <p className="movie-card__meta">
                <span className="movie-card__genre">{filmDetails.genre}</span>
                <span className="movie-card__year">{filmDetails.year}</span>
              </p>
      ...
      <div className="page-content">
        <section className="catalog">
          ...
          <div className="catalog__movies-list">
            ...
            {movies.map((movie) => (
              <article key={Math.random()} className="small-movie-card catalog__movies-card">
